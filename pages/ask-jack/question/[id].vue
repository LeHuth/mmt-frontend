...
<template>
    <div class="min-h-full theme-modebg-white dark:bg-black0">
            ...
            <div class="w-full md:w-1/3">
                ...
                >
                    <div class="max-w-xxl w-full p-4">
                        <div
                            class="p-8 bg-white dark:bg-black rounded shadow-md"
                        >
                            ...
                            <div
                                class="mt-5"
                                v-if="isMine && showEditForm == false"
                            >
                                <button
                ...
                >
                    <div class="max-w-xxl w-full p-4">
                        <div
                            class="p-8 bg-white dark:bg-slate-900 rounded shadow-md"
                        >
                            <div class="flex justify-end dark:text-gray-300">
                                {{ answer.authorName }}
                            </div>
                ...
                <div class="flex justify-end">
                    <button
                        v-if="!showAnswerForm && isLoggedIn"
